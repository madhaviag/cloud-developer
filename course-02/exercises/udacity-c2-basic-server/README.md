...
This project uses NPM to manage software dependencies. The NPM Relies on the package.json file located in the root of this repository. After cloning, open your terminal and run:
```bash
npm install
```
